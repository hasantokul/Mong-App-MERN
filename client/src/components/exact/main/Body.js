...
import UsersInfo from "../../users/profile/UsersInfo"
import UsersFavorites from "../../users/profile/UsersFavorites"
import UsersSongs from "../../users/lists/UsersSongs"
import UsersMovies from "../../users/lists/UsersMovies"
        ...
        <div style = {{marginTop:"1em"}}>
            ...
            <Container>
                    ...
                    <div class="col-lg-3"> 
                        ...
                        <Route path = "/user/profile" exact component = {UsersInfo}></Route>
                        <Route path = "/user/profile/songs" exact component = {UsersInfo}></Route>
                        <Route path = "/user/profile/movies" exact component = {UsersInfo}></Route>
                    ...
                    <Switch>
                        ...
                        <Route path = "/user/profile" exact component = {UsersFavorites}></Route>
                        <Route path = "/user/profile/songs" exact component = {UsersSongs}></Route>
                        <Route path = "/user/profile/movies" exact component = {UsersMovies}></Route>
